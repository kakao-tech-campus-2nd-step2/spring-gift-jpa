...
public class ProductRequestTest {
    ...
    public void testAddProductValid() {
        ...
        ResponseEntity<ProductRequest> response = restTemplate.postForEntity("/api/products",
            productDTO, ProductRequest.class);
    ...
    public void testAddProductNameTooLong() {
        ProductRequest productDTO = new ProductRequest(null, "This name is definitely too long",
            100, "valid.jpg");
        ResponseEntity<Map> response = restTemplate.postForEntity("/api/products", productDTO,
            Map.class);

        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.BAD_REQUEST);
        assertThat(response.getBody()).containsEntry("name",
