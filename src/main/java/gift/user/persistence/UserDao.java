...
import static gift.user.persistence.UserQuery.DELETE_USER;
import static gift.user.persistence.UserQuery.INSERT_USER;
import static gift.user.persistence.UserQuery.SELECT_USER_BY_USERNAME_AND_PASSWORD;
