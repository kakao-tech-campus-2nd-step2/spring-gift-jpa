...
-- Insert users
INSERT INTO users (email, password) VALUES ('user1@example.com', '111');
INSERT INTO users (email, password) VALUES ('user2@example.com', '222');
INSERT INTO users (email, password) VALUES ('user3@example.com', '333');
...
INSERT INTO wishlist (user_id, product_id) VALUES ((SELECT id FROM users WHERE email = 'user1@example.com'), (SELECT id FROM product WHERE name = 'Product 1'));